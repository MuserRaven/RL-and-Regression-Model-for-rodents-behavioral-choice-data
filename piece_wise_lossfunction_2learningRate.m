function [MAE] = piece_wise_lossfunction_2learningRate(alpha_r,alpha_nr,r,beta,bias,gamma,mi_memo,choice_data,reward_data,choice_type_data, sound_cue_data)
...
for t=1:N-1
      ...
      if choice_type(t) == 2
          if rat_reward(t) == 1      
            q1(t+1) =  q1(t) + alpha_r*(rat_reward(t) - q1(t)) ; % + r*mutual_info1(t)
            q2(t+1) =  (1-gamma)*(q2(t));
          else
            q1(t+1) =  q1(t) + alpha_nr*(rat_reward(t) - q1(t))  ; % + r*mutual_info1(t)
            q2(t+1) =  (1-gamma)*(q2(t));
          end
    
      elseif choice_type(t) == 3 
          if rat_reward(t) == 1  
            q2(t+1) =  q2(t) + alpha_r*(rat_reward(t) - q2(t)) ; % + r*mutual_info2(t)
            q1(t+1) =  (1-gamma)*(q1(t)) ;
          else
            q2(t+1) =  q2(t) + alpha_nr*(rat_reward(t) - q2(t)) ; % + r*mutual_info2(t)
            q1(t+1) =  (1-gamma)*(q1(t));
          end
